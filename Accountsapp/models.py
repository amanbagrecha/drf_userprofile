...
# creating custom model of `User` base model. `from django.contrib.auth.models import User`
...
# each time a new user is created, we generate a token
@receiver(post_save, sender=settings.AUTH_USER_MODEL)
def create_auth_token(sender, instance=None, created=False, **kwargs):
    if created: # if account object is created
